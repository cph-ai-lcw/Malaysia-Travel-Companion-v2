export const DIGITAL_GUIDE = Object.freeze({
  ...
  sections: {
    ...
    hotels: {
      ...
      cards:[
        { icon:'🌺', titleZh:'大紅花海上泳池渡假村', titleVi:'Lexis Hibiscus Port Dickson', linesZh:['住宿：9/20、9/21','英文：Lexis Hibiscus Port Dickson','電話：+60 6-660 2626','早餐自 07:00 起；Day 3 請於 07:00–07:30 用餐','SKY BAR 每人一杯無酒精飲料已包含於團費','私人泳池及水上活動請遵守飯店安全規定'], linesVi:['Lưu trú: 20/9 và 21/9','Tên tiếng Anh: Lexis Hibiscus Port Dickson','Điện thoại: +60 6-660 2626','Bữa sáng từ 07:00; Day 3 dùng bữa 07:00–07:30','Mỗi người có 1 ly nước không cồn tại SKY BAR, đã bao gồm','Tuân thủ quy định an toàn tại hồ bơi riêng và khu hoạt động biển'] },
        { icon:'🏙️', titleZh:'雙威偉樂酒店', titleVi:'Sunway Velocity Hotel', linesZh:['住宿：9/22、9/23','英文：Sunway Velocity Hotel','電話：+60 3-2726 3988','早餐 06:30 起，改至商場 5 樓 V-Office Function Room 享用自助餐（原餐廳維修至 9/30）','現場會有早餐動線指示，請依指示前往','鄰近 Sunway Velocity Mall','離房前請確認護照、房卡、充電器及個人物品'], linesVi:['Lưu trú: 22/9 và 23/9','Tên tiếng Anh: Sunway Velocity Hotel','Điện thoại: +60 3-2726 3988','Bữa sáng buffet từ 06:30 tại phòng V-Office Function, tầng 5 của trung tâm thương mại (nhà hàng cũ sửa chữa đến 30/9)','Tại chỗ sẽ có biển chỉ dẫn đường đến khu ăn sáng','Gần Sunway Velocity Mall','Trước khi rời phòng hãy kiểm tra hộ chiếu, thẻ phòng, sạc và đồ cá nhân'] }
      ]
    },
    money: {
