export const FOOD_ASSISTANT = Object.freeze({
  ...
  items:[
    ...
    {id:'rainbow-sister-restaurant',icon:'🦐',category:'meal',day:4,location:'genting',nameZh:'虹姐鐵板海鮮',nameVi:'Hải sản bàn sắt Chị Hồng',priceMin:25,priceMax:55,spice:1,halal:false,vegetarian:false,included:true,placeZh:'第四天 11:30 午餐（雲頂）',placeVi:'Bữa trưa 11:30 ngày 4 (Genting)',tipZh:'雲頂行程後先於虹姐餐廳用餐，再搭纜車下山前往黑風洞。',tipVi:'Sau lịch trình Genting, dùng bữa tại Nhà hàng Chị Hồng trước rồi đi cáp treo xuống núi đến Động Batu.'},
