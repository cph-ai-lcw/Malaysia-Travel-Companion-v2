export const FOOD_ASSISTANT = Object.freeze({
  ...
  items:[
    ...
    {id:'red-sister-restaurant',icon:'🦐',category:'meal',day:4,location:'genting',nameZh:'紅姐鐵板海鮮',nameVi:'Hải sản bàn sắt Chị Hồng',priceMin:25,priceMax:55,spice:1,halal:false,vegetarian:false,included:true,placeZh:'第四天午餐方案 A（11:30 仍在山上）',placeVi:'Phương án ăn trưa A ngày 4 (11:30 vẫn còn trên núi)',tipZh:'若 11:30 仍在雲頂山上，先於紅姐餐廳用餐，再下山前往黑風洞。',tipVi:'Nếu lúc 11:30 vẫn còn trên Genting, dùng bữa tại Nhà hàng Chị Hồng trước rồi xuống núi đi Động Batu.'},
    {id:'dong-yang-restaurant',icon:'🍽️',category:'meal',day:4,location:'batu-caves',nameZh:'東陽餐廳',nameVi:'Nhà hàng Dong Yang',priceMin:25,priceMax:55,spice:1,halal:false,vegetarian:false,included:true,placeZh:'第四天午餐方案 B（已結束雲頂行程）',placeVi:'Phương án ăn trưa B ngày 4 (đã kết thúc lịch trình Genting)',tipZh:'若 11:30 已下山，先參觀黑風洞，再到附近的東陽餐廳用餐；香港美食家推薦。',tipVi:'Nếu lúc 11:30 đã xuống núi, tham quan Động Batu trước rồi dùng bữa tại Nhà hàng Dong Yang gần đó; được chuyên gia ẩm thực Hồng Kông giới thiệu.'},
