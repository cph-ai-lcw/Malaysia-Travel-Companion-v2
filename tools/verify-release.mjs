...
const required=['index.html','manifest.webmanifest','service-worker.js','js/app.js','js/leader-store.js','js/translation.js','js/pages/leader.js','cloudflare-worker/src/index.js','cloudflare-worker/wrangler.jsonc','data/trip/members.js','data/trip/rooms.js','data/trip/seats.js','images/line-group-qr.jpg'];
required.forEach(file=>{if(!fs.existsSync(path.join(root,file)))errors.push(`缺少 ${file}`)});

for(const file of ['js/app.js','js/leader-store.js','js/translation.js','js/pages/leader.js']){
