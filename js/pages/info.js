...
export function infoPage() {
  ...
  return `
    ...
    <section class="card section leader-entry"><span>🧭</span><div><p class="eyebrow">LEADER MODE</p><h2>${bi("領隊管理中心", "Trung tâm trưởng đoàn")}</h2><p>${bi("房號、公告、點名與資料備份。", "Số phòng, thông báo, điểm danh và sao lưu.")}</p><a class="primary-btn inline-btn" href="#/leader">${bi("領隊登入", "Đăng nhập trưởng đoàn")}</a></div></section>
