...
const seed=()=>({version:2,settings:{pinHash:'',pinConfigured:false},announcements:[],sessions:blankSessions(),attendance:{},qr:{},roomNumbers:{},updatedAt:new Date().toISOString()});
export function loadLeader(){const data=storage.get(KEY,null);return data&&typeof data==='object'?{...seed(),...data,settings:{...seed().settings,...data.settings},roomNumbers:{...(data.roomNumbers||{})}}:seed()}
