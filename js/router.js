const allowed=new Set(['home','itinerary','my-travel','checklist','wallet','guide','info','leader','leader-rooms','leader-mdac','leader-meals','leader-announcements','leader-attendance','leader-backup']);
