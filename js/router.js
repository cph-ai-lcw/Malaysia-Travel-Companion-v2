const allowed=new Set(['home','itinerary','my-travel','checklist','wallet','guide','info','leader','leader-rooms','leader-announcements','leader-attendance','leader-qr','leader-backup']);
