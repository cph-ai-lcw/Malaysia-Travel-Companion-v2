const allowed=new Set(['home','itinerary','my-travel','checklist','wallet','guide','info','leader','leader-rooms','leader-mdac','leader-announcements','leader-attendance','leader-backup']);
